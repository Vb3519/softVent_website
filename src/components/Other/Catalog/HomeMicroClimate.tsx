...
const HomeMicroClimate = () => {
  return (
    <InfoSection>
      ...
      <h2 className="text-left text-[22px] font-[600]">Домашний микроклимат</h2>
      <div className="min-h-[400px] flex flex-col gap-5">
        <MdOutlineWbSunny className="m-auto text-[150px] md:text-[200px] text-gray-200" />
        <div className="flex flex-col gap-3 text-[14px] leading-[20px] sm:text-[16px] lg:text-[18px] lg:leading-[25px]">
          <h3 className="font-[600] text-center">
            Здесь будет информация о поставляемых нами бытовых вент системах!
          </h3>
          <p>
